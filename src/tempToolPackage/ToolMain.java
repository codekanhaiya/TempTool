...
public class ToolMain extends Application{
	...
	private tempToolPackage.ToolController control;
	...
	private void aboutApp() {
		...
		alertDialog.setTitle("Java Journey Begins 🚀");
		alertDialog.setHeaderText("Welcome to the Temperature Converter!");
		alertDialog.setContentText("This is just the beginning. With consistent learning and practice, amazing Java projects — including awesome games — are right around the corner. Let's keep building!");
		alertDialog.show();
